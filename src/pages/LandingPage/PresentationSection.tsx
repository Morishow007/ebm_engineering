        ...
        <section className="flex items-center bg:#e5e7eb xl:h-full my-20 font-poppins ">
          <div className="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div className="flex items-center justify-around my-8 -mx-4">
                ...
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full px-12 py-10 lg:w-3/5 lg:px-4 lg:mb-0 lg:py-20">
                    <div className="mx-auto lg:max-w-md">
                      ...
                      <div className="flex items-center ">
                        ...
                        <a
                          className="inline-flex items-center justify-center w-12 h-12 mr-4 text-blue-500  bg-white"
                          href="#"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a
                          className="inline-flex items-center justify-center w-12 h-12 mr-4 text-pink-600  bg-white "
                          href="#"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-full px-4 lg:w-2/5">
                    ...
                    <div className="text-center lg:hidden">
                      <button className="text-blue-900 border-2 border-blue-900 w-14 h-14">
                        <svg
                          className="mx-auto"
                          width="12"
                          height="16"
              ...
              {/* Right Arrow */}
              <div className="px-4">
                <button className="flex-shrink-0 hidden w-16 h-16 ml-2 text-gray-700 bg:#e5e7eb border-2 lg:block hover:bg-blue-300 rounded-full">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
